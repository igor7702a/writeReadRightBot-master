...
public class XLSLoadUsersProfilesService {
    ...
    public void xlsLoadUsersProfilesNewFormat() throws IOException {
        ...
        FileInputStream inputStream = new FileInputStream(new File("C:/Books/settings/usersprofiles/usersprofiles.xlsx"));
    ...
    public void xlsLoadUsersProfilesNewFormat(FileInputStream fisXlsxUsersProfiles) throws IOException {
        ...
        // Read XSL file
        FileInputStream inputStream = fisXlsxUsersProfiles;
